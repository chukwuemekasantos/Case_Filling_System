...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner" style="height: 80px;">
      
      <div class="container-fluid" style="margin-top: -10px;">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.html">STHCAB SYSTEM</a></div>
         ...
         <div class="ml-auto w-35">
            <div class="dropdown">
                  <button  type="button" class="btn btn-sm dropdown-toggle nav-link" data-toggle="dropdown" style="background-color:#7971EA; color: white;">File A Case
                  <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li><a href="member/register_individual.php" id="a">Individual</a></li>
                        <li><a href="member/register_organization.php" id="a">Organization</a></li>
                  </ul>
               </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Case Filing System</h1>
 ...
 -->
                 ...
                 <div id="reset" class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
               
                  <form action="" method="post" class="form-box">
                      <h3 class="h4 text-black mb-4">Enter Email</h3>
                       <?php
                        ...
                        switch ($reset) {
                                 case 'user_registered':
                                     echo '
                                           ...
                                           <div class="alert alert-success alert-sm text-center" style="font-size:18px;">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                              Success, Check your email for pasword reset link.
                                           </div>
                    ...
                    <div class="form-group">
                      <input type="submit" name="send_link" class="btn btn-primary btn-pill" value="Send Reset Link">
                    </div>


                     <div class="form-group">
                        <a href="#" onclick="window.location.href='index.php'">Login</a>
                    </div>
